...
class JobR(Job):
    ...
    def __init__(self, jobInfo):
        super(JobR,self).__init__(jobInfo)
        ...
        try:
            ...
            if file_ext.lower() == '.r':
             #EXECUTE PROCESS
                ...
                subprocess.call([CONS.RSCRIPT, local_code_to_execute], stdout=outfd, stderr=errfd, shell=False);
                ...
                msg = "Unexpected error: ", "Trying to execute a Non-R file"
