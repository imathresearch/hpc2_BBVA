""" Implements the class JobOctave, a sub class of the class Job
...
class JobOctave(Job):
    ...
    def __init__(self, jobInfo):
        super(JobOctave,self).__init__(jobInfo)
        ...
        try:
            ...
            if file_ext.lower() == '.m':
             #EXECUTE PROCESS
                ...
                subprocess.call([CONS.OCTAVESCRIPT, local_code_to_execute], stdout=outfd, stderr=errfd, shell=False);
                ...
                msg = "Unexpected error: ", "Trying to execute a Non-Octave file"
